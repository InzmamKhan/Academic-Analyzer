...
def main():
    ...
    # 2. Extract expected columns to pass to our parser for verification
    # We always need the core student identities + whatever columns are defined in the schema
    required_cols = ["Student_ID", "Student_Name"] + [
        settings["csv_column"] for settings in config["assessments"].values()
    ]

    # 3. Step 1: Run Ingestion Pipeline
    ...
    # 5. Step 3: Run Document Presentation Generator
